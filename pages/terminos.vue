...
<template>
    <section id="three" class="wrapper style2">
        <div class='container'>
                ...
                <p>Proveedora Reysi en cumplimiento a la Ley Federal de Protección de Datos Personales en Posesión de Particulares (“la Ley”), y su reglamento, hacen de su conocimiento que: protege y salvaguarda sus datos personales para evitar el daño, pérdida, destrucción, robo, extravío, alteración, así como el tratamiento no autorizado.</p>
                <p>En esta sección, encontrarás los términos y condiciones aplicables a cada promoción publicada dentro de nuestro sitio.</p>
                <p>El cliente o comprador autoriza que en caso de que se agote el producto, se realice la devolución de su compra.</p>
                <p>Proveedora Reysi ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.</p>
                ...
                <p>Por favor, lee estos Términos de Servicio cuidadosamente antes de acceder o utilizar nuestro sitio web. Al acceder o utilizar cualquier parte del sitio, estás aceptando los Términos de Servicio. Si no estás de acuerdo con todos los términos y condiciones de este acuerdo, entonces no deberás acceder a la página web o usar cualquiera de los servicios. Si los Términos de Servicio son considerados una oferta, la aceptación está expresamente limitada a estos Términos de Servicio.</p>
                ...
                <h4>Exactitud, exhaustividad y actualidad de la información</h4>
                ...
                <p>Los precios de nuestros productos están sujetos a cambio sin previo aviso.</p>
                <p>Nos reservamos el derecho de modificar o discontinuar el Servicio (o cualquier parte del contenido) en cualquier momento sin previo aviso.</p>
